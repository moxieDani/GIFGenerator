...
//  GIFGenerator
//
//  Created by Daniel on 2023/03/27.
//
...
class DeviceInfo {
    ...
    static func getModelName() -> String {
        ...
        switch model {
            ...
            default:                                        return "Latest Apple Device"
        }
    }
    
    static func getMaximumNumberOfImageFrame() -> Int {
        let FRAME_100 = 100
        let FRAME_150 = 150
        let FRAME_200 = 200
        ...
        switch getModelName() {
            ...
            // iPod
                ,"iPod Touch"
            // iPad
                ,"iPad","iPad 2","iPad Mini","iPad 3","iPad 4"
                ,"iPad Air"
                ,"iPad Mini 2","iPad Mini 3","iPad Mini 4","iPad Air 2"
                ,"iPad 5"
            // iPhone
                ,"iPhone"
            ...
            case "iPhone 6s","iPhone 6s Plus","iPhone SE","iPhone 7","iPhone 7 Plus"
